...
public class Commandwarp extends EssentialsCommand {
    ...
    public void run(final Server server, final CommandSource sender, final String commandLabel, final String[] args) throws Exception {
        ...
        otherUser.getAsyncTeleport().warp(otherUser, args[0], TeleportCause.COMMAND, getNewExceptionFuture(sender, commandLabel));
    }
    ...
    private void warpUser(final User owner, final User user, final String name, final String commandLabel) throws Exception {
        ...
        owner.getAsyncTeleport().warp(user, name, TeleportCause.COMMAND, getNewExceptionFuture(user.getSource(), commandLabel));
    }
